...
class LocationDisableDialog(private val onDialogResult: (Boolean) -> Unit) :
    DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.dialogText.text = "Your GPS seems to be disabled, do you want to enable it?"
        binding.allowDialogButton.text = "Open GPS settings"
